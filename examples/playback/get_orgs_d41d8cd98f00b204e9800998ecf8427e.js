...
module.exports = function (req, res) {
  ...
  res.setHeader('date', 'Mon, 26 Mar 2018 07:46:55 GMT')
  res.setHeader('content-type', 'application/json; charset=utf-8')
  res.setHeader('content-length', '611')
  res.setHeader('connection', 'close')
  res.setHeader('status', '200 OK')
  res.setHeader('x-ratelimit-limit', '60')
  res.setHeader('x-ratelimit-remaining', '37')
  ...
  res.setHeader('x-runtime-rack', '0.017692')
  res.setHeader('x-github-request-id', 'C0EC:6FC0:3A220F6:7332CD7:5AB8A56F')
