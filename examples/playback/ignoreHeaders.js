...
module.exports = function (req, res) {
  ...
  res.setHeader('date', 'Mon, 26 Mar 2018 07:56:02 GMT')
  res.setHeader('content-type', 'application/json; charset=utf-8')
  res.setHeader('content-length', '611')
  res.setHeader('connection', 'close')
  res.setHeader('status', '200 OK')
  res.setHeader('x-ratelimit-limit', '60')
  res.setHeader('x-ratelimit-remaining', '32')
  ...
  res.setHeader('x-runtime-rack', '0.018078')
  res.setHeader('x-github-request-id', 'C156:6FC1:306DFE1:794548F:5AB8A792')
