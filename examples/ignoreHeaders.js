/*
 * Example for ignore headers usage. Result is stored in `playback/noRedirects.js`
 */
...
const debug = require('debug')('node-vcr:examples:ignoreHeaders')
...
const handler = nodeVcr(proxyTarget, {
  dirname,
  hash,
  ignoreHeaders: ['content-security-policy']
})
